# -*- coding: utf-8 -*-
"""
Created on Mon Mar  6 17:45:30 2023
...
"""
txid = mc.create('stream', 'hassan', False)  # open to all to write
re1 = mc.listpermissions('hassan.write')  # all permissions
...
# print(txid)
txid = mc.grant(address, 'hassan.write')  # per-entity permission
print(txid)
"""
...
re4 = mc.createrawsendfrom(address, {result[1]['address']: 0}, [
                           {'for': 'hassan', 'key': 'key1', 'data': 'a1b2c3d4'}], 'sign')
print(re4)
"""
...
Server = mc.subscribe('hassan')
Client = mc1.subscribe('hassan')


result = mc.liststreamitems('hassan')
print(result)
"""
The response should contain the txid of the sent transaction.
Finally let’s check that the item was published successfully.
