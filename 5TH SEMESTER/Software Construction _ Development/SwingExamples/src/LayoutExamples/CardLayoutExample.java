...
//		JButton likeButton=new JButton(new ImageIcon("like.png")); 
	...
	likeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(currCard == 1) {
					++lcount1;
					likeJLabel.setText(" like: " + lcount1);
				}
				if(currCard == 2) {
					++lcount2;
					likeJLabel.setText(" like: " + lcount2);
				}
				if(currCard == 3) {
					++lcount3;
					likeJLabel.setText(" like: " + lcount3);
				}
	...
	dislikeButton.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(currCard == 1) {
				++dcount1;
				dislikeJLabel.setText("dislike: " + dcount1);
			}
			
			if(currCard == 2) {
				++dcount2;
				dislikeJLabel.setText("dislike: " + dcount2);
			}
			
			if(currCard == 2) {
				++dcount3;
				dislikeJLabel.setText("dislike: " + dcount3);
			}
		}
	});
