...
interface IRect {
    ...
    boolean holds(ARectangle rect);

    boolean covers(ARectangle rect);
}

class ARectangle implements IRect {
    private float ptX;
    private float ptY;
    private float wd;
    private float ht;
...
public class Code3 {
    ...
    public static void main(String[] args) {
        IRect rect01 = new ARectangle(1.5f, 1.5f, 5.5f, 4.9f);
